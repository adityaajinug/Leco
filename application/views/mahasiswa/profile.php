                ...
                <div class="card-body pt-0">
                    ...
                    <div class="text-center">
                        ...
                        <div class="h5 font-weight-300">
                            <i class="ni location_pin mr-2"></i>Umur 19th
                        </div>
                        <div class="h5 mt-4">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-username" class="form-control" value="A22.2019.02734" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-first-name" class="form-control" placeholder="Masukan Nama" value="<?= $user['nama']; ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
