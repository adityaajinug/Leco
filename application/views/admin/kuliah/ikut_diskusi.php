    ...
    <div class="row rounded-lg overflow-hidden shadow">
        ...
        <div class="col-12 px-0">
            <div class="px-4 py-5 chat-box ">
                ...
                <!-- Typing area -->
                <form method="POST" action="<?= base_url('kuliah_admin/kirim_pesan') ?>" class="bg-light">
                    <div class="input-group">
                        ...
                        <input type="hidden" name="id_pesan" value="<?= $judul['id_pesan']; ?>">
