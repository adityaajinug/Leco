    ...
    <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <h6 class="navbar-heading p-0 text-muted">
                <span class="docs-normal">Kemahasiswaan</span>
            </h6>
            <!-- Nav items -->
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('awal') ?>">
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link" href="">
                        ...
                        <span class="nav-link-text">Halaman Nilai</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="">
                        <i class="fas fa-calendar-check text-primary"></i>
                        <span class="nav-link-text">KRS KU</span>
                    </a>
                </li> -->
                <li class="nav-item">
                    <a class="nav-link " href="<?= base_url('awal/kuliah') ?>">
                        <i class="fas fa-chalkboard-teacher text-primary"></i>
                        <span class="nav-link-text">Halaman Kuliah</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('awal/profile') ?>">
            ...
            <ul class="navbar-nav mb-md-3">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('awal/job') ?>">
                        <i class="fas fa-user-md text-green"></i>
                        <span class="nav-link-text">Job Fair</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('awal/magang') ?>">
